...
from sglang.srt.managers.tp_worker import TpModelWorker, TpModelWorkerSim
...
from sglang.srt.server_args import PortArgs, ServerArgs, SimBinds
...
class SchedulerSim(Scheduler):
    def __init__(
        ...
        if self.enable_overlap:
            ...
            # TpWorkerClass = TpModelWorker
            TpWorkerClass = TpModelWorkerSim
