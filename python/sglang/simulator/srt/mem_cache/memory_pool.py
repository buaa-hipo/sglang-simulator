...
from sglang.simulator.srt.configs.mamba_utils import BaseLinearStateParams
from sglang.simulator.srt.layers.attention.nsa import index_buf_accessor
...
from sglang.simulator.srt.mem_cache.utils import (
    get_mla_kv_buffer_triton,
    maybe_init_custom_mem_pool,
    set_mla_kv_buffer_triton,
    set_mla_kv_scale_buffer_triton,
)
from sglang.simulator.srt.utils import is_cuda, is_npu, next_power_of_2
...
class MHATokenToKVPoolFP4(MHATokenToKVPool):
    ...
    def _get_key_buffer(self, layer_id: int):
        ...
        if self.store_dtype != self.dtype:
            ...
            from sglang.simulator.srt.layers.quantization.kvfp4_tensor import KVFP4QuantizeUtil
...
class MLATokenToKVPoolFP4(MLATokenToKVPool):
    ...
    def set_mla_kv_buffer(
        ...
        if self.use_nsa and self.nsa_kv_cache_store_fp8:
            ...
            if cache_k_nope.dtype != self.dtype:
                from sglang.simulator.srt.layers.quantization.kvfp4_tensor import (
                    KVFP4QuantizeUtil,
                )
