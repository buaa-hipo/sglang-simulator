...
from sglang.simulator.srt.lora.backend.lora_registry import LORA_SUPPORTED_BACKENDS
...
class LoRAAdapter(nn.Module):
    ...
    def initialize_weights(self):
        ...
        from sglang.simulator.srt.lora.utils import get_normalized_target_modules
