...
from sglang.simulator.srt.connector import ConnectorType
...
from sglang.simulator.srt.utils.hf_transformers_utils import check_gguf_file, get_config
...
class ServerArgs:
    ...
    def _handle_npu_backends(self):
        if self.device == "npu":
            from sglang.simulator.srt.hardware_backend.npu.utils import set_default_server_args
