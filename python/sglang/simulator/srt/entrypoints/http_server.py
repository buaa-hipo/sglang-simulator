...
from sglang.simulator.srt.tracing.trace import process_tracing_init, trace_set_thread_info
...
from sglang.simulator.srt.disaggregation.utils import FAKE_BOOTSTRAP_HOST, DisaggregationMode
from sglang.simulator.srt.entrypoints.engine import _launch_subprocesses
from sglang.simulator.srt.entrypoints.openai.protocol import (
...
from sglang.simulator.srt.entrypoints.openai.serving_chat import OpenAIServingChat
from sglang.simulator.srt.entrypoints.openai.serving_classify import OpenAIServingClassify
from sglang.simulator.srt.entrypoints.openai.serving_completions import OpenAIServingCompletion
from sglang.simulator.srt.entrypoints.openai.serving_embedding import OpenAIServingEmbedding
from sglang.simulator.srt.entrypoints.openai.serving_rerank import OpenAIServingRerank
from sglang.simulator.srt.entrypoints.openai.serving_score import OpenAIServingScore
from sglang.simulator.srt.entrypoints.openai.serving_tokenize import (
    OpenAIServingDetokenize,
    OpenAIServingTokenize,
)
from sglang.simulator.srt.entrypoints.warmup import execute_warmups
from sglang.simulator.srt.environ import envs
from sglang.simulator.srt.function_call.function_call_parser import FunctionCallParser
...
from sglang.simulator.srt.managers.multi_tokenizer_mixin import (
...
from sglang.simulator.srt.managers.template_manager import TemplateManager
from sglang.simulator.srt.managers.tokenizer_manager import ServerStatus, TokenizerManager
from sglang.simulator.srt.metrics.func_timer import enable_func_timer
from sglang.simulator.srt.parser.reasoning_parser import ReasoningParser
from sglang.simulator.srt.server_args import PortArgs, ServerArgs
...
async def lifespan(fast_api_app: FastAPI):
    ...
    if server_args.tool_server == "demo":
        from sglang.simulator.srt.entrypoints.openai.tool_server import DemoToolServer

        tool_server = DemoToolServer()
    elif server_args.tool_server:
        from sglang.simulator.srt.entrypoints.openai.tool_server import MCPToolServer

        tool_server = MCPToolServer()
        await tool_server.add_tool_server(server_args.tool_server)

    try:
        from sglang.simulator.srt.entrypoints.openai.serving_responses import (
...
def launch_server(
    ...
    try:
        ...
        if server_args.tokenizer_worker_num == 1:
            ...
            LOGGING_CONFIG["loggers"]["sglang.simulator.srt.entrypoints.http_server"] = {
                "handlers": ["default"],
                "level": "INFO",
                "propagate": False,
            }
            ...
            uvicorn.run(
                "sglang.simulator.srt.entrypoints.http_server:app",
                host=server_args.host,
                port=server_args.port,
                root_path=server_args.fastapi_root_path,
                log_level=server_args.log_level_http or server_args.log_level,
