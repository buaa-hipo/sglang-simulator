...
from sglang.simulator.srt.entrypoints.openai.protocol import ErrorResponse, OpenAIServingRequest
from sglang.simulator.srt.managers.io_struct import EmbeddingReqInput, GenerateReqInput
