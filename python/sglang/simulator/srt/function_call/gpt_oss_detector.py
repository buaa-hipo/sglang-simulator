...
from sglang.simulator.srt.entrypoints.openai.protocol import Tool
...
from sglang.simulator.srt.function_call.core_types import (
    StreamingParseResult,
    ToolCallItem,
    _GetInfoFunc,
)
from sglang.simulator.srt.parser.harmony_parser import HarmonyParser
