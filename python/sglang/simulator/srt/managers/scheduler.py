...
from sglang.simulator.srt.configs.model_config import ModelConfig
from sglang.simulator.srt.constrained.base_grammar_backend import (
    INVALID_GRAMMAR_OBJ,
...
from sglang.simulator.srt.disaggregation.decode_kvcache_offload_manager import (
    DecodeKVCacheOffloadManager,
)
from sglang.simulator.srt.disaggregation.prefill import (
    PrefillBootstrapQueue,
    SchedulerDisaggregationPrefillMixin,
)
from sglang.simulator.srt.disaggregation.utils import (
    DisaggregationMode,
    MetadataBuffers,
...
from sglang.simulator.srt.distributed import get_pp_group, get_world_group
from sglang.simulator.srt.dllm.config import DllmConfig
...
from sglang.simulator.srt.layers.dp_attention import compute_dp_attention_world_info
from sglang.simulator.srt.layers.moe import initialize_moe_config
from sglang.simulator.srt.layers.quantization.fp8_utils import initialize_fp8_gemm_config
from sglang.simulator.srt.managers.io_struct import (
    AbortReq,
    BaseBatchReq,
    BaseReq,
...
from sglang.simulator.srt.managers.mm_utils import init_mm_embedding_cache
from sglang.simulator.srt.managers.overlap_utils import FutureMap
from sglang.simulator.srt.managers.schedule_batch import (
    FINISH_ABORT,
    ModelWorkerBatch,
    MultimodalInputs,
    Req,
...
from sglang.simulator.srt.managers.schedule_policy import (
    AddReqResult,
    PrefillAdder,
    SchedulePolicy,
)
from sglang.simulator.srt.managers.scheduler_dp_attn_mixin import SchedulerDPAttnMixin
from sglang.simulator.srt.managers.scheduler_input_blocker import SchedulerInputBlocker
from sglang.simulator.srt.managers.scheduler_metrics_mixin import (
    RECORD_STEP_TIME,
    SchedulerMetricsMixin,
)
from sglang.simulator.srt.managers.scheduler_output_processor_mixin import (
    SchedulerOutputProcessorMixin,
)
from sglang.simulator.srt.managers.scheduler_pp_mixin import SchedulerPPMixin
from sglang.simulator.srt.managers.scheduler_profiler_mixin import SchedulerProfilerMixin
from sglang.simulator.srt.managers.scheduler_recv_skipper import SchedulerRecvSkipper
from sglang.simulator.srt.managers.scheduler_runtime_checker_mixin import (
    SchedulerRuntimeCheckerMixin,
)
from sglang.simulator.srt.managers.scheduler_update_weights_mixin import (
    SchedulerUpdateWeightsMixin,
)
from sglang.simulator.srt.managers.session_controller import Session
from sglang.simulator.srt.managers.utils import GenerationBatchResult, validate_input_length
from sglang.simulator.srt.mem_cache.cache_init_params import CacheInitParams
from sglang.simulator.srt.mem_cache.common import release_kv_cache
from sglang.simulator.srt.mem_cache.radix_cache import RadixCache
from sglang.simulator.srt.model_executor.forward_batch_info import ForwardMode
from sglang.simulator.srt.multiplex.multiplexing_mixin import SchedulerMultiplexMixin
from sglang.simulator.srt.parser.reasoning_parser import ReasoningParser
from sglang.simulator.srt.server_args import PortArgs, ServerArgs, get_global_server_args
from sglang.simulator.srt.speculative.spec_info import SpeculativeAlgorithm
from sglang.simulator.srt.tracing.trace import (
...
from sglang.simulator.srt.utils.hf_transformers_utils import (
    get_processor,
    get_tokenizer,
...
class Scheduler(
    ...
    def __init__(
        ...
        from sglang.simulator.srt.managers.tp_worker import TpModelWorker
    ...
    def init_cache_with_memory_pool(self):
        ...
        if (
            ...
            if not self.is_hybrid_swa:
                from sglang.simulator.srt.mem_cache.chunk_cache import ChunkCache

                self.tree_cache = ChunkCache(params)
            else:

                from sglang.simulator.srt.mem_cache.chunk_cache import SWAChunkCache
            ...
            if envs.SGLANG_EXPERIMENTAL_CPP_RADIX_TREE.get():
                ...
                from sglang.simulator.srt.mem_cache.radix_cache_cpp import RadixCacheCpp

                logger.info("Using experimental C++ radix tree implementation.")
                self.tree_cache = RadixCacheCpp(params=params, server_args=server_args)
            elif self.enable_hierarchical_cache:
                from sglang.simulator.srt.mem_cache.hiradix_cache import HiRadixCache
                ...
                from sglang.simulator.srt.mem_cache.swa_radix_cache import SWARadixCache

                self.tree_cache = SWARadixCache(
                    params=params, sliding_window_size=self.sliding_window_size
                )
            elif self.is_ssm_model:
                from sglang.simulator.srt.mem_cache.mamba_radix_cache import MambaRadixCache

                self.tree_cache = MambaRadixCache(params)
            elif server_args.enable_lmcache:
                from sglang.simulator.srt.mem_cache.storage.lmcache.lmc_radix_cache import (
                    LMCRadixCache,
                )
