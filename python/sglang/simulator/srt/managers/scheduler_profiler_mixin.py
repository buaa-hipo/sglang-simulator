...
from sglang.simulator.srt.managers.io_struct import ProfileReq, ProfileReqOutput, ProfileReqType
...
from sglang.simulator.srt.utils.profile_merger import ProfileMerger
from sglang.simulator.srt.utils.profile_utils import ProfileManager
...
class SchedulerProfilerMixin:
    ...
    def stop_profile(
        ...
        if self.rpd_profiler is not None:
            ...
            torch.distributed.barrier(self.cpu_group)
            if self.tp_rank == 0:
                from sglang.simulator.srt.utils.rpd_utils import rpd_to_chrome_trace
