...
from sglang.simulator.srt.model_executor.model_runner import ModelRunnerSimulator
...
class TpModelWorkerSimulator(TpModelWorker):
    def __init__(
        self,
        ...
        self._model_runner = ModelRunnerSimulator(
