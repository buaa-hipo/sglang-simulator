...
from sglang.simulator.srt.model_executor.forward_batch_info import ForwardBatch
...
from sglang.simulator.srt.constrained.base_grammar_backend import BaseGrammarObject
from sglang.simulator.srt.disaggregation.base import BaseKVSender
from sglang.simulator.srt.disaggregation.decode_schedule_batch_mixin import (
    ScheduleBatchDisaggregationDecodeMixin,
)
from sglang.simulator.srt.disaggregation.utils import DisaggregationMode
from sglang.simulator.srt.distributed.parallel_state import get_tensor_model_parallel_rank
from sglang.simulator.srt.environ import envs
from sglang.simulator.srt.mem_cache.allocator import (
    BaseTokenToKVPoolAllocator,
    SWATokenToKVPoolAllocator,
)
from sglang.simulator.srt.mem_cache.base_prefix_cache import BasePrefixCache
from sglang.simulator.srt.mem_cache.chunk_cache import SWAChunkCache
from sglang.simulator.srt.mem_cache.common import (
    alloc_for_decode,
    alloc_for_extend,
...
from sglang.simulator.srt.mem_cache.memory_pool import ReqToTokenPool
from sglang.simulator.srt.mem_cache.radix_cache import RadixKey
from sglang.simulator.srt.mem_cache.swa_radix_cache import SWARadixCache
from sglang.simulator.srt.metrics.collector import SchedulerMetricsCollector, TimeStats
...
from sglang.simulator.srt.sampling.sampling_params import SamplingParams
from sglang.simulator.srt.server_args import ServerArgs, get_global_server_args
from sglang.simulator.srt.utils import flatten_nested_list
from sglang.simulator.srt.utils.cuda_ipc_transport_utils import CudaIpcTensorTransportProxy

if TYPE_CHECKING:
    from sglang.simulator.srt.configs.model_config import ModelConfig
    from sglang.simulator.srt.speculative.eagle_info import EagleDraftInput
    from sglang.simulator.srt.speculative.spec_info import SpecInput, SpeculativeAlgorithm
...
class MultimodalDataItem:
    ...
    def set_pad_value(self):
        ...
        """
        from sglang.simulator.srt.managers.mm_utils import hash_feature
...
class MultimodalInputs:
    ...
    def from_dict(obj: dict):
        ...
        if envs.SGLANG_MM_BUFFER_SIZE_MB.get() > 0:
            from sglang.simulator.srt.managers.mm_utils import (
                init_feature_buffer,
