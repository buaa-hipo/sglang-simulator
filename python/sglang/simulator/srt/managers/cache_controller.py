...
from sglang.simulator.srt.mem_cache.hicache_storage import (
...
if TYPE_CHECKING:
    ...
    from sglang.simulator.srt.mem_cache.memory_pool_host import HostKVCache
...
from sglang.simulator.srt.utils import get_device_module
...
class HiCacheController:
    ...
    def __init__(
        ...
        if storage_backend is not None:
            ...
            from sglang.simulator.srt.mem_cache.hicache_storage import get_hash_str
            ...
            from sglang.simulator.srt.mem_cache.storage import StorageBackendFactory
