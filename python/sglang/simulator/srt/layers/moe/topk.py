...
from sglang.simulator.srt.eplb import expert_location_dispatch
from sglang.simulator.srt.eplb.expert_distribution import get_global_expert_distribution_recorder
from sglang.simulator.srt.eplb.expert_location_dispatch import (
...
class TopK(CustomOp):
    ...
    def forward_npu(
        ...
        *,
        ...
        from sglang.simulator.srt.hardware_backend.npu.moe.topk import fused_topk_npu
...
def select_experts(
    ...
    *,
    ...
    if num_fused_shared_experts > 0 and _use_aiter:
        ...
        from sglang.simulator.srt.layers.moe.fused_moe_triton.fused_moe_triton_kernels import (
