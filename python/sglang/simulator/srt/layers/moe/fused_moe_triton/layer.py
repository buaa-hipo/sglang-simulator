...
from sglang.simulator.srt.batch_overlap.two_batch_overlap import MaybeTboDeepEPDispatcher
...
from sglang.simulator.srt.eplb.expert_location import get_global_expert_location_metadata
...
from sglang.simulator.srt.layers.moe.kt_ep_wrapper import (
    KTEPWrapperMethod,
    create_kt_config_from_server_args,
)
from sglang.simulator.srt.layers.moe.token_dispatcher import CombineInput, DispatchOutput
from sglang.simulator.srt.layers.moe.token_dispatcher.base import BaseDispatcher
from sglang.simulator.srt.layers.moe.token_dispatcher.standard import (
    StandardDispatcher,
    StandardDispatchOutput,
)
from sglang.simulator.srt.layers.moe.topk import TopKOutput, TopKOutputChecker
...
from sglang.simulator.srt.layers.quantization.fp8 import Fp8MoEMethod
from sglang.simulator.srt.layers.quantization.modelopt_quant import ModelOptNvFp4FusedMoEMethod
from sglang.simulator.srt.layers.quantization.unquant import UnquantizedFusedMoEMethod
from sglang.simulator.srt.model_loader.weight_utils import narrow_padded_param_and_loaded_weight
...
def create_moe_dispatcher(moe_runner_config: MoeRunnerConfig) -> BaseDispatcher:
    ...
    if a2a_backend.is_none():
        ...
        from sglang.simulator.srt.layers.moe.token_dispatcher import NpuFuseEPDispatcher
