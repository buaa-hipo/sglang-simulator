...
from sglang.simulator.srt.utils import cpu_has_amx_support, is_cpu, is_cuda, is_hip
...
def fused_experts_none_to_triton(
    ...
    from sglang.simulator.srt.layers.moe.fused_moe_triton.fused_moe import fused_experts
