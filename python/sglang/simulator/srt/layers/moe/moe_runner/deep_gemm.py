...
from sglang.simulator.srt.layers.moe.moe_runner.base import (
    MoeQuantInfo,
    MoeRunnerConfig,
    MoeRunnerCore,
    RunnerInput,
...
from sglang.simulator.srt.layers.moe.utils import MoeRunnerBackend
from sglang.simulator.srt.utils import ceil_div, dispose_tensor, get_bool_env_var, is_hip, is_npu
from sglang.simulator.srt.utils.offloader import get_offloader

if TYPE_CHECKING:
    from sglang.simulator.srt.layers.moe.token_dispatcher.deepep import (
...
class DeepGemmRunnerCore(MoeRunnerCore):
    ...
    def _run_contiguous_gemm(
        ...
        from sglang.simulator.srt.layers.moe.ep_moe.kernels import tma_align_input_scale
    ...
    def _run_masked_gemm(
        ...
        from sglang.simulator.srt.layers import deep_gemm_wrapper
        from sglang.simulator.srt.layers.moe.ep_moe.kernels import (
...
def pre_permute_standard_to_deep_gemm(
    ...
    from sglang.simulator.srt.layers.moe.ep_moe.kernels import moe_ep_deepgemm_preprocess
...
def post_permute_deep_gemm_to_standard(
    ...
    from sglang.simulator.srt.layers.moe.ep_moe.kernels import post_reorder_triton_kernel
    from sglang.simulator.srt.layers.moe.token_dispatcher.standard import StandardCombineInput
...
def post_permute_deep_gemm_to_deepep_ll(
    ...
    from sglang.simulator.srt.layers.moe.token_dispatcher.deepep import DeepEPLLCombineInput
...
def pre_permute_deepep_normal_to_deep_gemm(
    ...
    from sglang.simulator.srt.layers.moe.ep_moe.kernels import ep_scatter
...
def post_permute_deep_gemm_to_deepep_normal(
    ...
    from sglang.simulator.srt.layers.moe.ep_moe.kernels import ep_gather
    from sglang.simulator.srt.layers.moe.token_dispatcher.deepep import DeepEPNormalCombineInput
