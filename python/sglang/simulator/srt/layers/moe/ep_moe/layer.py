...
from sglang.simulator.srt.layers.moe.fused_moe_triton.layer import FlashInferFusedMoE, FusedMoE
...
from sglang.simulator.srt.layers.quantization.w4afp8 import W4AFp8Config, W4AFp8MoEMethod
from sglang.simulator.srt.utils import get_bool_env_var, is_hip, is_npu
...
class DeepEPMoE(FusedMoE):
    ...
    def run_moe_core(
        ...
        from sglang.simulator.srt.layers.moe.token_dispatcher import DispatchOutputChecker
    ...
    if get_moe_runner_backend().is_flashinfer_trtllm():
        ...
        try:
            ...
            if quant_config is not None and quant_config.get_name() == "modelopt_fp4":
                from sglang.simulator.srt.layers.moe.fused_moe_triton.layer import (
                    FlashInferFP4MoE,
                )
