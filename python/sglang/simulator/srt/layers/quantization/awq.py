...
from sglang.simulator.srt.hardware_backend.npu.quantization.fused_moe_method_npu import (
    npu_fused_experts,
)
from sglang.simulator.srt.layers.linear import LinearBase, set_weight_attrs
...
from sglang.simulator.srt.layers.moe.moe_runner.marlin import MarlinMoeQuantInfo
from sglang.simulator.srt.layers.parameter import GroupQuantScaleParameter, PackedvLLMParameter
...
from sglang.simulator.srt.layers.quantization.marlin_utils import (
...
from sglang.simulator.srt.layers.quantization.utils import get_scalar_types, replace_parameter
...
from sglang.simulator.srt.utils import is_cuda, is_hip, is_npu, is_xpu
