...
from sglang.simulator.srt.layers.quantization.utils import all_close_1d, per_tensor_dequantize
...
if _use_aiter:
    ...
    from sglang.simulator.srt.layers.moe.rocm_moe_utils import rocm_fused_experts_tkw1

OCP_MX_BLOCK_SIZE = 32

if TYPE_CHECKING:
    from sglang.simulator.srt.layers.quantization import QuarkConfig
