...
from sglang.simulator.srt.layers.quantization.utils import get_scalar_types

ScalarType, scalar_types = get_scalar_types()


from sglang.simulator.srt.layers.linear import LinearBase, UnquantizedLinearMethod
...
class AutoRoundConfig(QuantizationConfig):
    ...
    def apply_awq_quant_layer(self, layer, prefix: str, backend: str = "auto"):
        ...
        if backend == "auto" or "marlin" in backend:
            ...
            use_marlin = False
        if use_marlin:
            from sglang.simulator.srt.layers.quantization.awq import (
                AWQMarlinConfig,
            ...
            from sglang.simulator.srt.layers.quantization.awq import AWQConfig, AWQLinearMethod
    ...
    def apply_gptq_quant_layer(self, layer, prefix: str, backend: str = "auto"):
        ...
        if backend == "auto" or "marlin" in backend:
            ...
            use_marlin = False
        if use_marlin:
            from sglang.simulator.srt.layers.quantization.gptq import (
                GPTQMarlinConfig,
            ...
            from sglang.simulator.srt.layers.quantization.gptq import GPTQConfig, GPTQLinearMethod
