...
from sglang.simulator.srt.layers.parameter import BlockQuantScaleParameter, ModelWeightParameter
...
from sglang.simulator.srt.layers.quantization.int8_utils import apply_w8a8_block_int8_linear
