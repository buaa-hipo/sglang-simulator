...
from sglang.simulator.srt.distributed import get_tensor_model_parallel_world_size, get_tp_group
from sglang.simulator.srt.distributed.device_communicators.pynccl_allocator import (
    use_symmetric_memory,
)
from sglang.simulator.srt.layers.amx_utils import _amx_process_weight_after_loading
from sglang.simulator.srt.layers.dp_attention import is_allocation_symmetric
from sglang.simulator.srt.layers.moe import MoeRunner, MoeRunnerBackend, MoeRunnerConfig
from sglang.simulator.srt.layers.moe.moe_runner.deep_gemm import DeepGemmMoeQuantInfo
from sglang.simulator.srt.layers.moe.moe_runner.triton import TritonMoeQuantInfo
from sglang.simulator.srt.layers.moe.utils import get_moe_runner_backend
from sglang.simulator.srt.layers.parameter import (
    BlockQuantScaleParameter,
    ModelWeightParameter,
    PerTensorScaleParameter,
)
from sglang.simulator.srt.layers.quantization.base_config import (
    FusedMoEMethodBase,
    LinearMethodBase,
    QuantizationConfig,
    QuantizeMethodBase,
...
from sglang.simulator.srt.layers.quantization.kv_cache import BaseKVCacheMethod
from sglang.simulator.srt.layers.quantization.marlin_utils_fp8 import (
    apply_fp8_marlin_linear,
    prepare_fp8_layer_for_marlin,
)
from sglang.simulator.srt.layers.quantization.unquant import UnquantizedLinearMethod
from sglang.simulator.srt.layers.quantization.utils import (
    all_close_1d,
...
if TYPE_CHECKING:
    from sglang.simulator.srt.layers.moe.token_dispatcher import (
        CombineInput,
        DispatchOutput,
        StandardDispatchOutput,
    )
    from sglang.simulator.srt.layers.moe.topk import TopKOutput
    from sglang.simulator.srt.layers.quantization.w4afp8 import W4AFp8Config
...
class Fp8Config(QuantizationConfig):
    ...
    def get_quant_method(
        ...
        from sglang.simulator.srt.layers.linear import LinearBase
        from sglang.simulator.srt.layers.moe.fused_moe_triton import FusedMoE
...
class Fp8MoEMethod(FusedMoEMethodBase):
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        from sglang.simulator.srt.layers.moe.fused_moe_triton import FusedMoeWeightScaleSupported
    ...
    def process_weights_after_loading(self, layer: Module) -> None:
        ...
        if self.block_quant:
            ...
            if _is_fp8_fnuz:
                ...
                from sglang.simulator.srt.layers.moe.ep_moe.layer import DeepEPMoE
                from sglang.simulator.srt.model_loader.utils import (
                    should_deepgemm_weight_requant_ue8m0,
                )
    ...
    def process_weights_hip_scale_padding(self, layer: Module):
        from sglang.simulator.srt.layers.moe.fused_moe_triton.fused_moe import (
    ...
    def create_moe_runner(
        ...
        from sglang.simulator.srt.layers.moe.utils import get_moe_a2a_backend
    ...
    def apply(
        ...
        from sglang.simulator.srt.layers.moe.token_dispatcher import StandardCombineInput

        x = dispatch_output.hidden_states
        moe_runner_config = self.moe_runner_config

        if use_intel_amx_backend(layer):
            from sglang.simulator.srt.layers.moe.topk import apply_topk_weights_cpu
        ...
        if get_moe_runner_backend().is_cutlass():
            from sglang.simulator.srt.layers.moe.cutlass_moe import cutlass_fused_experts_fp8
    ...
    def apply_with_router_logits(
        ...
        from sglang.simulator.srt.layers.moe.topk import TopKOutputChecker
