...
from sglang.simulator.srt.layers.linear import UnquantizedLinearMethod
from sglang.simulator.srt.layers.quantization.base_config import (
    FusedMoEMethodBase,
    QuantizationConfig,
    QuantizeMethodBase,
)
from sglang.simulator.srt.layers.quantization.fp8 import Fp8LinearMethod
...
from sglang.simulator.srt.utils import set_weight_attrs

if TYPE_CHECKING:
    from sglang.simulator.srt.layers.moe import MoeRunnerConfig
...
class W4AFp8MoEMethod(FusedMoEMethodBase):
    ...
    def apply(
        ...
        from sglang.simulator.srt.layers.moe.cutlass_w4a8_moe import cutlass_w4a8_moe
    ...
    def apply_deepep_ll(
        ...
        from sglang.simulator.srt.layers.moe.cutlass_w4a8_moe import cutlass_w4a8_moe_deepep_ll
    ...
    def apply_deepep_normal(
        ...
        from sglang.simulator.srt.layers.moe.cutlass_w4a8_moe import (
