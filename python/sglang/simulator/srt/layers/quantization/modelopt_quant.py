...
from sglang.simulator.srt.distributed import get_tp_group
...
from sglang.simulator.srt.layers.moe.cutlass_moe_params import CutlassMoEParams, CutlassMoEType
from sglang.simulator.srt.layers.moe.moe_runner.triton import TritonMoeQuantInfo
from sglang.simulator.srt.layers.parameter import ModelWeightParameter, PerTensorScaleParameter
...
from sglang.simulator.srt.layers.quantization.fp8_kernel import scaled_fp8_quant
...
from sglang.simulator.srt.utils.common import (
    get_bool_env_var,
    is_cuda,
    is_sm120_supported,
    next_power_of_2,
)
from sglang.simulator.srt.utils.patch_torch import register_fake_if_exists

if TYPE_CHECKING:
    from sglang.simulator.srt.batch_overlap.single_batch_overlap import DownGemmOverlapArgs
...
class ModelOptNvFp4FusedMoEMethod(FusedMoEMethodBase):
    ...
    def enable_flashinfer_cutlass_moe(self) -> bool:
        from sglang.simulator.srt.layers.moe import get_moe_runner_backend
    ...
    def apply(
        ...
        from sglang.simulator.srt.layers.moe.cutlass_moe import cutlass_moe_fp4
    ...
    def apply_without_routing_weights(
        ...
        from sglang.simulator.srt.layers.moe.flashinfer_cutedsl_moe import (
