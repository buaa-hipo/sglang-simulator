...
def _per_token_group_quant_8bit_fuse_silu_and_mul(
    ...
    from sglang.simulator.srt.layers.moe.ep_moe.kernels import silu_and_mul_masked_post_quant_fwd
...
def sglang_per_token_group_quant_8bit(
    ...
    from sglang.simulator.srt.layers.quantization.int8_kernel import (
