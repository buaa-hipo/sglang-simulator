...
from sglang.simulator.srt.configs.model_config import get_nsa_index_topk, is_deepseek_nsa
...
from sglang.simulator.srt.layers.attention.nsa.nsa_indexer import BaseIndexerMetadata
from sglang.simulator.srt.layers.attention.nsa.quant_k_cache import quantize_k_cache
from sglang.simulator.srt.layers.attention.nsa.transform_index import (
...
from sglang.simulator.srt.layers.attention.trtllm_mla_backend import _concat_mla_absorb_q_general
from sglang.simulator.srt.layers.dp_attention import get_attention_tp_size
from sglang.simulator.srt.model_executor.forward_batch_info import ForwardBatch, ForwardMode
from sglang.simulator.srt.utils import is_hip
...
if TYPE_CHECKING:
    ...
    from sglang.simulator.srt.speculative.spec_info import SpecInput
...
class NativeSparseAttnBackend(AttentionBackend):
    ...
    def _forward_tilelang(
        ...
        from sglang.simulator.srt.layers.attention.nsa.tilelang_kernel import tilelang_sparse_fwd
    ...
    def set_nsa_prefill_impl(self, forward_batch: Optional[ForwardBatch] = None):
        ...
        """
        from sglang.simulator.srt.utils import get_device_sm, is_blackwell
