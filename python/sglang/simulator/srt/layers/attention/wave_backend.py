...
from sglang.simulator.srt.utils import get_bool_env_var, get_device_core_count
...
class WaveAttnBackend(AttentionBackend):
    def __init__(
        ...
        from sglang.simulator.srt.layers.attention.wave_ops.decode_attention import (
            decode_attention_fwd,
        )
        from sglang.simulator.srt.layers.attention.wave_ops.extend_attention import (
