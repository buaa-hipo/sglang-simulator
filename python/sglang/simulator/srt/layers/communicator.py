...
if _use_aiter and _is_gfx95_supported:
    ...
    from sglang.simulator.srt.layers.quantization.rocm_mxfp4_utils import fused_rms_mxfp4_quant
elif _is_npu:
    from sglang.simulator.srt.hardware_backend.npu.cmo import prepare_weight_cache
