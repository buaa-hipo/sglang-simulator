...
from sglang.simulator.srt.utils.common import fast_topk, is_cuda, is_hip, is_npu, next_power_of_2
...
class EagleDraftInputV2Mixin:
    def prepare_for_decode(self: EagleDraftInput, batch: ScheduleBatch):
        from sglang.simulator.srt.speculative.spec_utils import assign_req_to_token_pool_func
