...
from sglang.simulator.srt.layers.dp_attention import get_attention_tp_group
...
from sglang.simulator.srt.layers.sampler import get_token_ids_logprobs, get_top_logprobs
from sglang.simulator.srt.managers.io_struct import UpdateWeightsFromTensorReqInput
from sglang.simulator.srt.managers.schedule_batch import ScheduleBatch
...
from sglang.simulator.srt.speculative.eagle_info import (
    EagleDraftInput,
    EagleVerifyInput,
    EagleVerifyOutput,
)
from sglang.simulator.srt.speculative.eagle_utils import (
