...
from sglang.simulator.srt.hardware_backend.npu.graph_runner.eagle_draft_extend_npu_graph_runner import (
    EAGLEDraftExtendNpuGraphRunner,
)
from sglang.simulator.srt.hardware_backend.npu.graph_runner.eagle_draft_npu_graph_runner import (
    EAGLEDraftNpuGraphRunner,
)
from sglang.simulator.srt.layers.moe.utils import (
    speculative_moe_a2a_backend_context,
    speculative_moe_backend_context,
)
from sglang.simulator.srt.managers.io_struct import UpdateWeightsFromTensorReqInput
from sglang.simulator.srt.managers.schedule_batch import ModelWorkerBatch
from sglang.simulator.srt.managers.scheduler import GenerationBatchResult
from sglang.simulator.srt.managers.tp_worker import TpModelWorker
from sglang.simulator.srt.model_executor.forward_batch_info import CaptureHiddenMode, ForwardBatch
from sglang.simulator.srt.server_args import ServerArgs
from sglang.simulator.srt.speculative.base_spec_worker import BaseDraftWorker, BaseSpecWorker
from sglang.simulator.srt.speculative.draft_utils import DraftBackendFactory
from sglang.simulator.srt.speculative.eagle_draft_cuda_graph_runner import (
    EAGLEDraftCudaGraphRunner,
)
from sglang.simulator.srt.speculative.eagle_draft_extend_cuda_graph_runner import (
    EAGLEDraftExtendCudaGraphRunner,
)
from sglang.simulator.srt.speculative.eagle_info import EagleDraftInput, EagleVerifyInput
from sglang.simulator.srt.speculative.eagle_info_v2 import (
    assign_extend_cache_locs,
    fill_accepted_out_cache_loc,
    fill_new_verified_id,
    select_top_k_tokens_tmp,
)
from sglang.simulator.srt.speculative.eagle_utils import TreeMaskMode, build_tree_kernel_efficient
from sglang.simulator.srt.speculative.spec_info import SpeculativeAlgorithm
from sglang.simulator.srt.speculative.spec_utils import (
    detect_nan,
    draft_tp_context,
