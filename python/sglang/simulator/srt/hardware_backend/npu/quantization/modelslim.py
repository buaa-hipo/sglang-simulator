...
from sglang.simulator.srt.hardware_backend.npu.quantization.linear_method_npu import (
...
from sglang.simulator.srt.utils import apply_module_patch
    ...
    def __init__(self, quant_config: Dict[str, Any] = {}):
        ...
        for name in self.quant_description.keys():
            if "norm.bias" in name:
                apply_module_patch(
                    "sglang.simulator.srt.layers.layernorm.RMSNorm",
                    "__init__",
