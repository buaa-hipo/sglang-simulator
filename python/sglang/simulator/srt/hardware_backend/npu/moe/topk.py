...
from sglang.simulator.srt.eplb.expert_location_dispatch import topk_ids_logical_to_physical
from sglang.simulator.srt.layers.moe.topk import StandardTopKOutput, select_experts

if TYPE_CHECKING:
    from sglang.simulator.srt.eplb.expert_location_dispatch import ExpertLocationDispatchInfo
    from sglang.simulator.srt.layers.moe.topk import TopKConfig, TopKOutput
