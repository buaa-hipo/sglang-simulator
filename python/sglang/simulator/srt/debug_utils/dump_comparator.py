...
from sglang.simulator.srt.debug_utils.dump_loader import find_row, read_meta
from sglang.simulator.srt.debug_utils.dumper import get_truncated_value
...
if __name__ == "__main__":
    # python -m sglang.simulator.srt.debug_utils.dump_comparator --baseline-path ... --target-path ...
