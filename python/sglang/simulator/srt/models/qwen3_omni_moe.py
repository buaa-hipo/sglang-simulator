...
from sglang.simulator.srt.configs.qwen3_omni import (
    Qwen3OmniMoeAudioEncoderConfig,
    Qwen3OmniMoeThinkerConfig,
    Qwen3OmniMoeVisionEncoderConfig,
)
from sglang.simulator.srt.configs.qwen3_vl import Qwen3VLMoeConfig
...
from sglang.simulator.srt.managers.schedule_batch import MultimodalDataItem
from sglang.simulator.srt.model_loader.weight_utils import default_weight_loader
from sglang.simulator.srt.models.qwen3_vl import Qwen3VLMoeVisionModel
from sglang.simulator.srt.models.qwen3_vl_moe import (
    Qwen3MoeLLMModel,
    Qwen3VLMoeForConditionalGeneration,
    load_fused_expert_weights,
)
from sglang.simulator.srt.utils import add_prefix, logger
