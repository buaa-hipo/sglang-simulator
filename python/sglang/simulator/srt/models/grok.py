...
from sglang.simulator.srt.layers.activation import GeluAndMul
from sglang.simulator.srt.layers.elementwise import (
...
from sglang.simulator.srt.layers.moe.router import fused_moe_router_shim
...
from sglang.simulator.srt.layers.rotary_embedding import (
    RotaryEmbedding,
...
from sglang.simulator.srt.model_loader.loader import DefaultModelLoader
...
def _prepare_presharded_weights(
    ...
    if not os.path.isdir(model_name_or_path):
        from sglang.simulator.srt.model_loader.weight_utils import download_weights_from_hf
