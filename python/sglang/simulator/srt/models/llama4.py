...
from sglang.simulator.srt.layers.vocab_parallel_embedding import VocabParallelEmbedding
from sglang.simulator.srt.model_executor.forward_batch_info import (
    ForwardBatch,
    ForwardMode,
    PPProxyTensors,
)
from sglang.simulator.srt.models.llama import LlamaForCausalLM, LlamaMLP
...
from sglang.simulator.srt.utils.common import get_current_device_stream_fast
