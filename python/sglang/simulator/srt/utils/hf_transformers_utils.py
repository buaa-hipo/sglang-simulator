...
from sglang.simulator.srt.configs.internvl import InternVLChatConfig
from sglang.simulator.srt.connector import create_remote_connector
from sglang.simulator.srt.multimodal.customized_mm_processor_utils import _CUSTOMIZED_MM_PROCESSOR
from sglang.simulator.srt.utils import is_remote_url, logger, lru_cache_frozenset, mistral_utils
...
def get_tokenizer(
    ...
    **kwargs,
    ...
    if tokenizer_name.endswith(".json"):
        from sglang.simulator.srt.tokenizer.tiktoken_tokenizer import TiktokenTokenizer
