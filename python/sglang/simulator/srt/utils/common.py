...
def get_bool_env_var(name: str, default: str = "false") -> bool:
    # FIXME: move your environment variable to sglang.simulator.srt.environ
...
def make_layers(
    ...
    # circula imports
    from sglang.simulator.srt.distributed import get_pp_indices
...
def monkey_patch_p2p_access_check():
    ...
    import sglang.simulator.srt.distributed.device_communicators.custom_all_reduce_utils as tgt

    setattr(tgt, "gpu_p2p_access_check", lambda *arg, **kwargs: True)

    # Suppress the warnings from this delete function when using sglang.bench_one_batch
    from sglang.simulator.srt.distributed.device_communicators.custom_all_reduce import (
        CustomAllreduce,
    )
...
class SafeUnpickler(pickle.Unpickler):
    ALLOWED_MODULE_PREFIXES = {
        ...
        "huggingface_hub.",
        # --- SGLang & Unitest ---
        "sglang.simulator.srt.weight_sync.tensor_bucket.",
        "sglang.simulator.srt.model_executor.model_runner.",
        "sglang.simulator.srt.layers.",
        "sglang.simulator.srt.utils.",
    }
