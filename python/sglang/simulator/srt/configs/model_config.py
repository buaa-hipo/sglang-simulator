...
from sglang.simulator.srt.layers.quantization import QUANTIZATION_METHODS
from sglang.simulator.srt.server_args import ServerArgs
from sglang.simulator.srt.utils import is_hip, retry
...
class ModelConfig:
    ...
    def _is_already_quantized(self) -> bool:
        ...
        from sglang.simulator.srt.utils import has_hf_quant_config
    ...
    def _maybe_pull_model_tokenizer_from_remote(self) -> None:
        ...
        from sglang.simulator.srt.utils import is_remote_url
