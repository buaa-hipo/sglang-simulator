...
def may_get_weight_block_size(model_config, load_config):
    from sglang.simulator.srt.model_loader.loader import _get_quantization_config
    from sglang.simulator.srt.model_loader.utils import get_model_architecture
...
def update_intermediate_size(model_config, attr_name, intermediate_padding_size):
    ...
    if attr_value % intermediate_padding_size != 0:
        from sglang.simulator.srt.layers.vocab_parallel_embedding import pad_vocab_size
