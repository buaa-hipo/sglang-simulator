...
from sglang.simulator.srt.layers.attention.nsa.utils import NSAContextParallelMetadata
from sglang.simulator.srt.layers.attention.utils import create_flashinfer_kv_indices_triton
...
from sglang.simulator.srt.utils import get_compiler_backend, is_npu, support_triton
from sglang.simulator.srt.utils.common import ceil_align
...
if TYPE_CHECKING:
    ...
    from sglang.simulator.srt.managers.schedule_batch import ModelWorkerBatch, MultimodalInputs
    from sglang.simulator.srt.mem_cache.memory_pool import KVCache, ReqToTokenPool
...
class ForwardBatch:
    ...
    def adjust_num_token_non_padded_for_attn_tp(self, server_args) -> None:
        ...
        from sglang.simulator.srt.utils.common import require_mlp_tp_gather
    ...
    def prepare_mlp_sync_batch(self, model_runner: ModelRunner):
        from sglang.simulator.srt.batch_overlap.two_batch_overlap import TboForwardBatchPreparer
    ...
    def prepare_attn_tp_scatter_input(self, model_runner: ModelRunner):
        from sglang.simulator.srt.layers.communicator import get_attn_tp_context
    ...
    def prepare_chunked_prefix_cache_info(self, device: torch.device):
        ...
        from sglang.simulator.srt.mem_cache.memory_pool import MLATokenToKVPool
