...
from sglang.simulator.srt.compilation.compilation_config import CompilationConfig
from sglang.simulator.srt.compilation.compile import install_torch_compiled, set_compiled
from sglang.simulator.srt.compilation.piecewise_context_manager import (
...
from sglang.simulator.srt.utils import get_available_gpu_memory, is_npu, log_info_on_rank0
...
class PiecewiseCudaGraphRunner:
    ...
    def get_spec_info(self, num_tokens: int):
        ...
        if (
            ...
            from sglang.simulator.srt.speculative.eagle_utils import EagleVerifyInput
