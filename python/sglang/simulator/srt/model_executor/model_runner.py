...
from sglang.simulator.srt.configs import (
    FalconH1Config,
    JetNemotronConfig,
    JetVLMConfig,
    KimiLinearConfig,
...
from sglang.simulator.srt.configs.device_config import DeviceConfig
from sglang.simulator.srt.configs.load_config import LoadConfig, LoadFormat
from sglang.simulator.srt.configs.model_config import (
    AttentionArch,
    ModelConfig,
    ModelImpl,
...
from sglang.simulator.srt.configs.update_config import adjust_config_with_unaligned_cpu_tp
from sglang.simulator.srt.constants import GPU_MEMORY_TYPE_WEIGHTS
from sglang.simulator.srt.debug_utils.tensor_dump_forward_hook import (
...
from sglang.simulator.srt.distributed.parallel_state import monkey_patch_vllm_parallel_state
from sglang.simulator.srt.elastic_ep.elastic_ep import ElasticEPStateManager
from sglang.simulator.srt.eplb.eplb_manager import EPLBManager
from sglang.simulator.srt.eplb.expert_distribution import (
    ExpertDistributionRecorder,
    get_global_expert_distribution_recorder,
    set_global_expert_distribution_recorder,
)
from sglang.simulator.srt.eplb.expert_location import (
    ExpertLocationMetadata,
    compute_initial_expert_location_metadata,
    get_global_expert_location_metadata,
    set_global_expert_location_metadata,
)
from sglang.simulator.srt.eplb.expert_location_updater import ExpertLocationUpdater
from sglang.simulator.srt.hardware_backend.npu.graph_runner.npu_graph_runner import NPUGraphRunner
from sglang.simulator.srt.layers import deep_gemm_wrapper
from sglang.simulator.srt.layers.attention.attention_registry import (
    ATTENTION_BACKENDS,
    attn_backend_wrapper,
)
from sglang.simulator.srt.layers.attention.nsa.utils import is_nsa_enable_prefill_cp
from sglang.simulator.srt.layers.attention.tbo_backend import TboAttnBackend
from sglang.simulator.srt.layers.dp_attention import (
    DpPaddingMode,
...
from sglang.simulator.srt.layers.logits_processor import LogitsProcessorOutput
from sglang.simulator.srt.layers.pooler import EmbeddingPoolerOutput
from sglang.simulator.srt.layers.quantization.fp8_kernel import fp8_dtype
from sglang.simulator.srt.layers.sampler import Sampler
from sglang.simulator.srt.layers.torchao_utils import apply_torchao_config_to_model
from sglang.simulator.srt.lora.lora_manager import LoRAManager
from sglang.simulator.srt.lora.lora_registry import LoRARef
from sglang.simulator.srt.mem_cache.allocator import (
    BaseTokenToKVPoolAllocator,
    PagedTokenToKVPoolAllocator,
    SWATokenToKVPoolAllocator,
    TokenToKVPoolAllocator,
)
from sglang.simulator.srt.mem_cache.memory_pool import (
...
from sglang.simulator.srt.model_executor.cpu_graph_runner import CPUGraphRunner
from sglang.simulator.srt.model_executor.cuda_graph_runner import (
    CudaGraphRunner,
    set_torch_compile_config,
)
from sglang.simulator.srt.model_executor.forward_batch_info import (
    CaptureHiddenMode,
    ForwardBatch,
    ForwardMode,
    PPProxyTensors,
)
from sglang.simulator.srt.model_executor.hook_manager import register_forward_hooks
from sglang.simulator.srt.model_executor.input_buffers import GraphInputBuffers
from sglang.simulator.srt.model_executor.piecewise_cuda_graph_runner import (
    PiecewiseCudaGraphRunner,
)
from sglang.simulator.srt.model_loader import get_model
from sglang.simulator.srt.model_loader.loader import DefaultModelLoader, get_model_loader
from sglang.simulator.srt.model_loader.remote_instance_weight_loader_utils import (
    trigger_init_weights_send_group_for_remote_instance_request,
)
from sglang.simulator.srt.model_loader.utils import set_default_torch_dtype
from sglang.simulator.srt.model_loader.weight_utils import default_weight_loader
from sglang.simulator.srt.sampling.sampling_batch_info import SamplingBatchInfo
from sglang.simulator.srt.server_args import (
    ServerArgs,
    get_global_server_args,
    set_global_server_args_for_scheduler,
)
from sglang.simulator.srt.speculative.spec_info import SpeculativeAlgorithm
...
from sglang.simulator.srt.utils.nvtx_pytorch_hooks import PytHooks
from sglang.simulator.srt.utils.offloader import (
    create_offloader_from_server_args,
    get_offloader,
    set_offloader,
)
from sglang.simulator.srt.utils.patch_torch import monkey_patch_torch_reductions
from sglang.simulator.srt.utils.torch_memory_saver_adapter import TorchMemorySaverAdapter
from sglang.simulator.srt.utils.weight_checker import WeightChecker
from sglang.simulator.srt.weight_sync.tensor_bucket import (
...
if _is_npu:
    from sglang.simulator.srt.hardware_backend.npu.utils import init_npu_backend
...
class ModelRunner:
    ...
    def init_mindspore_runner(self):
        ...
        if self.server_args.model_impl.lower() == ModelImpl.MINDSPORE and _is_npu:
            from sglang.simulator.srt.model_executor.mindspore_runner import init_ms_distributed
    ...
    def initialize(self, min_per_gpu_memory: float):
        ...
        if server_args.enable_deterministic_inference:
            from sglang.simulator.srt.batch_invariant_ops import enable_batch_invariant_mode
    ...
    def load_model(self):
        ...
        from sglang.simulator.srt.configs.modelopt_config import ModelOptConfig
    ...
    def init_memory_pool(
        ...
        if self.req_to_token_pool is None:
            ...
            if self.server_args.disaggregation_mode == "decode":
                from sglang.simulator.srt.disaggregation.decode import (
        ...
        if self.server_args.attention_backend == "ascend":
            if self.use_mla_backend:
                from sglang.simulator.srt.hardware_backend.npu.memory_pool_npu import (
                    NPUMLATokenToKVPool,
                )
        ...
        if self.token_to_kv_pool_allocator is None:
            if _is_npu and (
                ...
                from sglang.simulator.srt.hardware_backend.npu.allocator_npu import (
    ...
    def _get_attention_backend(self, init_new_workspace: bool = False):
        ...
        if self.decode_attention_backend_str != self.prefill_attention_backend_str:
            from sglang.simulator.srt.layers.attention.hybrid_attn_backend import (
                HybridAttnBackend,
            )
    ...
    def _dummy_run(self, batch_size: int):
        ...
        def get_spec_info():
            spec_info = None
            if self.spec_algorithm.is_eagle() or self.spec_algorithm.is_standalone():
                from sglang.simulator.srt.speculative.eagle_info import EagleVerifyInput
                ...
                from sglang.simulator.srt.speculative.ngram_info import NgramVerifyInput
    ...
    def apply_torch_tp(self):
        ...
        from sglang.simulator.srt.layers.model_parallel import tensor_parallel
    ...
    def save_remote_model(self, url: str):
        from sglang.simulator.srt.model_loader.loader import RemoteModelLoader
    ...
    def save_sharded_model(
        ...
        from sglang.simulator.srt.model_loader.loader import ShardedStateLoader
    ...
    def update_weights_from_ipc(self, recv_req):
        ...
        try:
            from sglang.simulator.srt.checkpoint_engine.checkpoint_engine_worker import (
